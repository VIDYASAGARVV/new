            ...
            <div class="card-body">
                <form action="{{ url('admin/category/'.$category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="description" class="form-control" placeholder="enter description" rows="3">{{$category->description}}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <img src="{{ asset('/uploads/category/'.$category->image) }}" width="60px" height="50px" >
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="meta_keyword" value="{{$category->meta_keyword}}" class="form-control" placeholder="Enter Meta keywords" />
                    </div>
                    <div class="col-md-12 mb-3">
                        <label>Meta Description</label>
                        <textarea name="meta_description"  class="form-control" placeholder="enter meta description"  rows="3">{{$category->meta_description}}</textarea>
                    </div>
                    <div class="col-md-12 mb-3">
